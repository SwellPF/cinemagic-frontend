...
const Movie = (props) => {
    ...
    return (
        <div>   
            <div class='content-center'><img src={movie.image_link} alt='movie-poster'/></div><br/>
            <h2 class='text-left text-blue-700 font-bold text-3xl'>{movie.title}</h2>
            ...
            <Link to={`/movies/${movie.id}/edit`}> <button class="rounded-full bg-blue-500 py-.5 px-4">Edit Movie</button></Link><br/><br/>
